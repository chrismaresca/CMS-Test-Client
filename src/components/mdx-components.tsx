...
interface TestComponentProps extends React.ComponentProps<typeof Test> {}
...
const H5: FC<HeadingProps> = ({ children, ...props }) => (
  <h5
    {...props}
    className="text-lg font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2"
  >
    {children}
  </h5>
);
...
const H6: FC<HeadingProps> = ({ children, ...props }) => (
  <h6
    {...props}
    className="text-base font-medium text-gray-800 dark:text-gray-200 mt-4 mb-2 uppercase tracking-wide"
  >
    {children}
  </h6>
);
...
const P: FC<ParagraphProps> = ({ children, ...props }) => (
  <p
    {...props}
    className="text-lg leading-relaxed text-gray-700 dark:text-gray-300 my-4"
  >
    {children}
  </p>
);
...
const A: FC<AnchorProps> = ({ children, ...props }) => (
  <a
    {...props}
    className="text-blue-600 dark:text-blue-400 hover:underline decoration-2"
  >
    {children}
  </a>
);
...
const UL: FC<ListProps> = ({ children, ...props }) => (
  <ul
    {...props}
    className="list-disc list-inside ml-4 my-4 text-gray-700 dark:text-gray-300"
  >
    {children}
  </ul>
);
...
const OL: FC<ListProps> = ({ children, ...props }) => (
  <ol
    {...props}
    className="list-decimal list-inside ml-6 my-4 text-gray-700 dark:text-gray-300"
  >
    {children}
  </ol>
);
...
const PRE: FC<PreProps> = ({ children, ...props }) => (
  <pre
    {...props}
    className="bg-gray-900 text-gray-100 p-4 rounded overflow-x-auto my-4 font-mono text-sm"
  >
    {children}
  </pre>
);
...
const TABLE: FC<TableProps> = ({ children, ...props }) => (
  <table
    {...props}
    className="w-full border-collapse my-6 overflow-x-auto"
  >
    {children}
  </table>
);
...
const TH: FC<TableCellProps> = ({ children, ...props }) => (
  <th
    {...props}
    className="text-left px-4 py-2 text-gray-700 dark:text-gray-300 font-semibold"
  >
    {children}
  </th>
);
